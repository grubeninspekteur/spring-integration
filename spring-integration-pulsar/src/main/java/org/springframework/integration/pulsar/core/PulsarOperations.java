...
public interface PulsarOperations<V> {
	 ...
	 * @param data The data.
	 * @throws org.springframework.integration.pulsar.exception.NoDefaultTopicException
	 * @throws org.springframework.integration.pulsar.exception.ProducerException if the operation fails
	 ...
	 * with a {@link org.springframework.integration.pulsar.exception.ProducerException} and an exception of
	 * {@link org.apache.pulsar.client.api.PulsarClientException.ProducerQueueIsFullError} as its cause.
	 * @param data The data.
	 * @throws org.springframework.integration.pulsar.exception.NoDefaultTopicException if no default topic has been configured.
	 * @throws org.springframework.integration.pulsar.exception.ProducerException if the operation fails.
	...
	/**
	 * Send the data to the default topic using the given schema for serialization, and wait for its acknowledgement by the Pulsar broker.
	 * The schema does not have to conform with the operations type {@link V}.
	 * @param data The data.
	...
	/**
	 * Send the data to the given topic using the given schema for serialization. The schema does not have to conform
	 * with the operations type {@link V}.
	 * <p>Depending on the underlying producer configuration, when the producer queue is full, the future will fail
	 * with a {@link org.springframework.integration.pulsar.exception.ProducerException} and an exception of
	 * {@link org.apache.pulsar.client.api.PulsarClientException.ProducerQueueIsFullError} as its cause.
	 * @param topic The topic.
	 ...
	 */
	ListenableFuture<MessageId> send(Message<?> message);
